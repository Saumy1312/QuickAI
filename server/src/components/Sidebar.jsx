...
const Sidebar = ({ sidebar }) => {
  ...
  // Run slide-in effect only once when mounted at /ai
  useEffect(() => {
  ...
  return (
    <div
      className={`
        w-60 bg-white border-r border-gray-200 flex flex-col justify-between items-center max-sm:absolute top-14 bottom-0 z-50
